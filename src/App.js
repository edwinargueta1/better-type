...
import {
  clearStoredLessons,
  toggleState,
} from "./Functions/localDataManagement.js";
...
function App() {
  ...
  return (
    <div className="App">
      <LoginPopUp popUpState={isLoginActive} setPopUp={setIsLoginActive} />
      <SignUpPopUp popUpState={isSignUpActive} setPopUp={setIsSignUpActive} />
        <div className="title">
          ...
          <Route
            ...
            element={
              <TypeGame
                ...
                loadedTopUsers={loadedTopUsers}
                phraseHistoryData={phraseHistoryData}
                setPhraseHistoryData={setPhraseHistoryData}
      ...
      <div className="footer">
          <a href="https://github.com/edwinargueta1/better-type">
          <div className="logoWrapper">
            <img id="githubFooterLogo" src="github-logo.svg" />
            <p>GitHub</p>
          </div>
          </a>
        </div>
