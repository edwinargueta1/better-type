...
import { changeUsername, removeUser, userNameIsTaken, validFormatUserName } from "../config/firebase";
...
export default function SettingsPopUp(props) {
  ...
  function handleDelete(){
    ...
    if(count == 3){
        ...
        toggleState(props.popUpState, props.setPopUpState);
        navigate('/');
    }
  ...
  return props.popUpState ? (
    ...
    >
      <div className="popUpForm" onClick={(event) => event.stopPropagation()}>
