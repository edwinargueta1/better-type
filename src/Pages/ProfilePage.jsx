      ...
      {props.stats !== null ? (
        <div className="profilePage">
          ...
          <div className="profileRow">
            <StatCard
              title="Average WPM:"
              stat={parseFloat((props.stats.averageWPM ?? 0).toFixed(2))}
            />
            <StatCard
              title="Average Accuracy:"
              stat={`${parseFloat(
                (props.stats.averageAccuracy ?? 0).toFixed(2)
              )}%`}
            />
          </div>
          <div className="profileRow">
            ...
            <StatCard
              ...
              stat={toHHMMSS(props.stats.totalTimeInSec)}
            />
          </div>
          <div className="profileRow">
            <button
              ...
              onClick={() => {
                toggleState(popUpState, setPopUpState);
              }}
            >
              <svg
                fill="var(--textColor)"
        ...
        <ErrorPage error="Login or Sign up to view Profile Stats" />
      )}
    </div>
  );
}
